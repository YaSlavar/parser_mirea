...
class Format_name_test(unittest.TestCase):
    ...
    def test_example_5(self):
        ...
        correct_result = [['Оперционные системы', ['1', '5', '9', '13'], ''], ['Оперционные системы', ['3', '7', '11', '15'], '']]
        self.assertEqual(result, correct_result)

    def test_example_6(self):
        result = self.reader.format_name(
            "3,7,11,15  н Физика                                                     кр. 5,8,13.17 н Организация ЭВМ и Систем")
        correct_result = [['Физика', ['3', '7', '11', '15'], ''], ['Организация ЭВМ и Систем', '', ['5', '8', '13', '17']]]
        self.assertEqual(result, correct_result)
    ...
    def test_example_7(self):
        ...
        correct_result = [['Кроссплатформенная среда исполнения программного обеспечения', ['2', '6', '10', '14'], ''], ['Кроссплатформенная среда исполнения программного обеспечения', ['4', '8', '12', '16'], '']]
        self.assertEqual(result, correct_result)
